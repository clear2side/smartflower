...
(function() {
    (function(e, t, n) {
        ...
        r.prototype.init = function() {
            ...
            if (this.data.touch) { e(".slidesjs-control", n).on("touchstart", function(e) {
            ...
            e(".slidesjs-next", n).click(function(e) { e.preventDefault();
                a.stop(!0);
        ...
        r.prototype.play = function(t) {
            ...
            if (!this.data.playInterval) {
                if (t) { r = this.data.current;
                    this.data.direction = "next";
                    this.options.play.effect === "fade" ? this._fade() : this._slide() }
                e.data(this, "playInterval", setInterval(function() { r = s.data.current;
                ...
                if (this.options.play.pauseOnHover) { i.unbind();
                    ...
                    i.bind("mouseleave", function() {
                        return s.options.play.restartDelay ? e.data(s, "restartDelay", setTimeout(function() {
                            return s.play(!0) }, s.options.play.restartDelay)) : s.play() }) }
        ...
        r.prototype._slide = function(t) {
            ...
            if (!this.data.animating && t !== this.data.current + 1) { e.data(this, "animating", !0);
                ...
                return a.stop().animate({ left: i }, this.options.effect.slide.speed, function() { a.css({ left: 0 });
                    a.children(":eq(" + o + ")").css({ left: 0 });
        ...
        r.prototype._fade = function(t) {
            ...
            if (!this.data.animating && t !== this.data.current + 1) { e.data(this, "animating", !0);
                ...
                return s.children(":eq(" + r + ")").stop().fadeOut(this.options.effect.fade.speed, function() { s.children(":eq(" + i + ")").stop().fadeIn(u.options.effect.fade.speed, function() {
        ...
        return e.fn[s] = function(t) {
            return this.each(function() {
                if (!e.data(this, "plugin_" + s)) return e.data(this, "plugin_" + s, new r(this, t)) }) } })(jQuery, window, document) }).call(this);
